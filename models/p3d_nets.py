...
class P3D(nn.Module):
    ...
    def __init__(self, block, layers, modality='RGB',
        shortcut_type='B', num_classes=400,dropout=0.5,ST_struc=('A','B','C'),final_pool=5):
        self.inplanes = 64
        ...
        self.avgpool = nn.AvgPool2d(kernel_size=(final_pool, final_pool), stride=1)                              # pooling layer for res5.
